...
<script type="text/javascript">
    ...
    function reloadCase(from, to) {
        ...
        createNewFormElement(submitForm, "from", from);
        createNewFormElement(submitForm, "to", to);
        submitForm.action = "/Reporting.mvc/agelist";
    ...
    <table class="tablesorter" width="100%" id="MemberCaseTable" style=" width:100%; padding:0; margin-left:0%; margin-right:0%">
			...
			<tr class="header">
				...
				<th width=3% nowrap="nowrap">Marital Status</th>
                <th width=2% nowrap="nowrap">Age</th>
		</thead>
		<tbody>
			    <% 
