...
<%if (HttpContext.Current.IsDebuggingEnabled){%>
    ...
    <script type="text/javascript" src="/Content/scripts/parish_ministry.debug.js"></script>
    
<%}else{%>
    <script type="text/javascript" src="/Content/scripts/common_function.min.js"></script>
    <script type="text/javascript" src="/Content/scripts/parish_ministry.min.js"></script>
<%}%>
...
<script type="text/javascript">
    function loadMinistry(ministryid) {
        ...
        submitForm.action = "/Parish.mvc/modifyAMinistry";
    ...
    <div class="container" style="width:830px">
        <ul class="tabs">
            <%if (ViewData["modify"] == null){ %>
                <li><a href="#tab1">List of Ministry</a></li>
                <li><a href="#tab2">Add a Ministry</a></li>
            <%}else
              {%>
                <li><a href="#tab2">Modify a Ministry</a></li>
              <%} %>
        </ul>
        <div class="tab_container">
            ...
            <div id="tab1" class="tab_content">
                <table class="dottedview" cellspacing="0">
                    <tr>
                        <td>
		                    <iframe id="StafflistIframe" frameborder="0" src="/parish.mvc/ListOfMinistry" style="width: 100%; height: 450px;">
            ...
            <div id="tab2" class="tab_content">
                <table class="dottedview" cellspacing="0">
                    <tr>
                        <td>
		                    <iframe id="Iframe1" frameborder="0" src="/parish.mvc/addMinistry<%=(string)ViewData["modify"] %>" style="width: 100%; height: 450px;">
                            <p>Your browser does not support iframes.</p></iframe>
                        </td>
