...
(function($,undefined){var multiselectID=0;$.widget("ech.multiselect",{options:{header:true,height:175,minWidth:225,classes:'',checkAllText:' all',uncheckAllText:' all',noneSelectedText:'Select options',selectedText:'# selected',selectedList:0,show:'',hide:'',autoOpen:false,multiple:true,HideCheckAll:false,HideUnCheckAll:false,position:{}},_create:function(){var el=this.element.hide(),o=this.options;this.speed=$.fx.speeds._default;this._isOpen=false;var
...
if(this.options.HideCheckAll===true){this.headerLinkContainer.find('.ui-multiselect-all').hide();}
if(this.options.HideUnCheckAll===true){this.headerLinkContainer.find('.ui-multiselect-none').hide();}
...
this.buttonlabel.html(value);return value;},_bindEvents:function(){var self=this,button=this.button;function clickHandler(){self[self._isOpen?'close':'open']();if(self._isOpen){$('.ui-multiselect-filter').find('input').focus();$('.ui-multiselect-filter').find('input').select();}
return false;}
