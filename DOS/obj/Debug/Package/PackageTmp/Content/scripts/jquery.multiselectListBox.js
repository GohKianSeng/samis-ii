    ...
    var msMethods = {
              ...
              scroll = 0;
                    ms.find('optgroup,option').each(function () {
                        ...
                        if ($(this).is('optgroup')) {
                            ...
                            var selectableImg = $('<img align="right" value="' + $(this).val() + '" id="" style="width:16px; height:16px;" src="' + getHelpIconSrc() + '"/>');
                            var selectableLi;
                            if ($(this).attr('originalSelected') == '1')
                                selectableLi = $('<li class="ms-elem-selectable OriginalSelected' + klass + '" ms-value="' + $(this).val() + '">' + $(this).text() + '</li>');
                            else
                                selectableLi = $('<li class="ms-elem-selectable' + klass + '" ms-value="' + $(this).val() + '">' + $(this).text() + '</li>');
                            selectableLi.append(selectableImg);
        ...
        'select': function (value, method) {
          ...
          titleAttr = selectedOption.attr('title');
            var selectedImg = $('<img align="right" class="ms-elem-selected" value="' + value + '" id="" style="width:16px; height:16px;" src="' + getHelpIconSrc() + '"/>');
            var selectedLi;
            if (document.getElementById(value.replace(/\./g, '_')).getAttribute("originalSelected") == '1') {
                selectedLi = $('<li class="OriginalSelected' + (klass ? ' ' + klass : '') + '" ms-value="' + value + '">' + text + '</li>'),
                ...
                selectedLi = $('<li class="ms-elem-selected' + (klass ? ' ' + klass : '') + '" ms-value="' + value + '">' + text + '</li>'),
                  selectableUl = $('#ms-' + ms.attr('id') + ' .ms-selectable ul'),
                  selectedUl = $('#ms-' + ms.attr('id') + ' .ms-selection ul'),
                  selectableLi = selectableUl.children('li[ms-value="' + value + '"]'),
                  haveToSelect = null;
            ...
            if (haveToSelect && selectedUl.children('li[ms-value="' + value + '"]').length == 0) {
                ...
                if (method != 'init' && ms.data('settings').keepOrder && selectedUlLis.length > 0) {
                    ...
                    selectedLi.append(selectedImg);
                    setHoverEvent(selectedImg);
                }
